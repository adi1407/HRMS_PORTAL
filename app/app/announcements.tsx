  ...
  return (
    <View style={[styles.screen, { backgroundColor: AppColors.background }]}>
      <SafeAreaView edges={["top"]} style={styles.safeTop}>
        <ScreenHeader title="Announcements" colors={colors} />
      </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  audienceBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 10, backgroundColor: '#eff6ff' },
  audienceText: { fontSize: 12, fontWeight: '600', color: '#1d4ed8' },
